...
RegisterTransformer.prototype.transformCallExpression = function(tree) {
  ...
  if (tree.operand.type == 'MEMBER_EXPRESSION' && tree.operand.memberName.value == 'register' && tree.operand.operand.type == 'IDENTIFIER_EXPRESSION' && tree.operand.operand.identifierToken.value == 'System' && tree.args) {
...
exports.compile = function(load, opts, loader) {
  ...
  var transformer = new RegisterTransformer(!opts.anonymous && load.name, function(dep) {
