...
function remap(source, map, fileName) {
  ...
  return Promise.resolve({source: compiler.write(tree)});
}
exports.remap = remap;
...
exports.compile = function(load, opts, loader) {
  ...
  return Promise.resolve(global[loader.transpiler == 'typescript' ? 'ts' : loader.transpiler] || loader.pluginLoader.import(loader.transpiler)).then(function(transpiler) {
