...
builder.config({
  ...
  meta: {
    'a.js': {format: 'esm'},
    'b.js': {format: 'esm'},
    'global-dep.js': {format: 'esm'},
    'global-dep-loader.js': {format: 'esm'}
  },
  paths: {
...
suite('SFX Optimizations', function() {
  test('All ES6 rollup optimization', function(done) {
    builder.buildStatic('a.js', 'test/output/es-sfx.js', {
      runtime: false,
      minify: minify,
      format: 'esm',
      rollup: true
  ...
  test('ES6 rollup with a global dep', function(done) {
    builder.buildStatic('global-dep.js', 'test/output/es-sfx.js', {
      runtime: false,
      minify: minify,
      format: 'esm',
      rollup: true
