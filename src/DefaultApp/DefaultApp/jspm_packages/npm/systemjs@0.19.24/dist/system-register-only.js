...
(function(process) {
  !function(e) {
    function t(e, t) {
      ...
      var o = (r ? r.join("\n	") : e.message) + "\n	" + t;
      g || (o = o.replace(y ? /file:\/\/\//g : /file:\/\//g, ""));
      var i = new Error(o, e.fileName, e.lineNumber);
      return g ? i.stack = null : i.stack = o, i.originalErr = e.originalErr || e, i;
    }
    function n(e, n, r) {
      try {
    ...
    function i(e, t) {
      ...
      for (var o in e) {
        ...
        if (1 == i.length) {
          ...
          var d = i[0].length;
          d >= a && t.substr(0, i[0].length) == i[0] && t.substr(t.length - i[1].length) == i[1] && (a = d, r = o, n = t.substr(i[0].length, t.length - i[1].length - i[0].length));
        }
      }
      var s = e[r];
    ...
    function m(e) {
      ...
      if ("object" == typeof e || "function" == typeof e)
        if (k) {
          var n;
          for (var r in e)
            (n = Object.getOwnPropertyDescriptor(e, r)) && b(t, r, n);
        } else {
          var a = e && e.hasOwnProperty;
          for (var r in e)
            (!a || e.hasOwnProperty(r)) && (t[r] = e[r]);
        }
      return t["default"] = e, b(t, "__useDefault", {value: !0}), t;
    }
    function p(e) {
      var t = e.match(R);
    ...
    var v = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts,
        ...
        y = "undefined" != typeof process && "undefined" != typeof process.platform && !!process.platform.match(/^win/);
    e.console || (e.console = {assert: function() {}});
    var b,
        w = Array.prototype.indexOf || function(e) {
          for (var t = 0,
              n = this.length; n > t; t++)
            if (this[t] === e)
              return t;
    ...
    !function() {
      try {
        Object.defineProperty({}, "a", {}) && (b = Object.defineProperty);
      } catch (e) {
        b = function(e, t, n) {
          try {
    ...
    b(r.prototype, "toString", {value: function() {
        return "Module";
      }}), function() {
      function o(e) {
        return {
      ...
      function u(t, r, a) {
        a.then(function(a) {
          return "loading" == r.status ? Promise.resolve(t.loaderObj.translate({
            ...
            if (void 0 === a)
              return r.address = r.address || "<Anonymous Module " + ++j + ">", r.isDeclarative = !0, O.call(t.loaderObj, r).then(function(t) {
                var a = e.System,
                    o = a.register;
            ...
            for (var e = r.depsList,
                ...
                o = e.length; o > a; a++)
              (function(e, a) {
                n.push(d(t, e, r.name, r.address).then(function(t) {
                  if (r.dependencies[a] = {
                    key: e,
                    value: t.name
                  }, "linked" != t.status)
      ...
      function c(e) {
        return function(t, n) {
          ...
          for (var d,
            ...
            if (r.loads[c].name == a && (d = r.loads[c], "translate" != i || d.source || (d.address = e.moduleAddress, u(r, d, Promise.resolve(e.moduleSource))), d.linkSets.length && d.linkSets[0].loads[0].name == d.name))
              return d.linkSets[0].done.then(function() {
                t(d);
              });
          var p = d || o(a);
          p.metadata = e.moduleMetadata;
          var h = f(r, p);
          r.loads.push(p), t(h.done), "locate" == i ? s(r, p) : "fetch" == i ? l(r, p, Promise.resolve(e.moduleAddress)) : (p.address = e.moduleAddress, u(r, p, Promise.resolve(e.moduleSource)));
        };
      }
      function f(e, t) {
        var n = {
          ...
          if (e.loader.loaderObj.execute === !1) {
            for (var r = [].concat(e.loads),
              ...
              t.module = t.isDeclarative ? {
                ...
                module: k({}),
                evaluated: !0
              } : {module: k({})}, t.status = "linked", g(e.loader, t);
            }
            return e.resolve(n);
          }
          var i = p(e);
      ...
      function v(e, n, r) {
        ...
        e: if (n)
          if (e.loads[0].name == n.name)
            ...
            for (var o = 0; o < e.loads.length; o++)
              for (var i = e.loads[o],
                  d = 0; d < i.dependencies.length; d++) {
                var s = i.dependencies[d];
                if (s.value == n.name) {
                  r = t(r, "Error loading " + n.name + ' as "' + s.key + '" from ' + i.name);
                  break e;
                }
              }
        ...
        for (var l = e.loads.concat([]),
            ...
            u = l.length; u > o; o++) {
          var n = l[o];
          a.loaderObj.failed = a.loaderObj.failed || [], -1 == w.call(a.loaderObj.failed, n) && a.loaderObj.failed.push(n);
          var c = w.call(n.linkSets, e);
          if (n.linkSets.splice(c, 1), 0 == n.linkSets.length) {
            var f = w.call(e.loader.loads, n);
      ...
      function g(e, t) {
        ...
        var r = w.call(e.loads, t);
        -1 != r && e.loads.splice(r, 1);
        for (var a = 0,
            o = t.linkSets.length; o > a; a++)
          r = w.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
      ...
      a.prototype = {
        ...
        "import": function(e, t, n) {
          ...
          return Promise.resolve(r.normalize(e, t)).then(function(e) {
            var t = r._loader;
            return t.modules[e] ? (_(t.modules[e], [], t._loader), t.modules[e].module) : t.importPromises[e] || x(r, e, i(t, e, {}).then(function(n) {
        ...
        load: function(e) {
          var t = this._loader;
          return t.modules[e] ? Promise.resolve() : t.importPromises[e] || x(this, e, new Promise(c({
            step: "locate",
            loader: t,
            moduleName: e,
            moduleMetadata: {},
    ...
    var _;
    d.prototype = a.prototype, o.prototype = new d;
    var O = /^([^\/]+:\/\/|\/)/;
    o.prototype.normalize = function(e, t, n) {
      return e = e.match(O) || "." == e[0] ? new S(e, t || x).href : new S(i(this.paths, e) || e, x).href;
    ...
    }, l.prototype = o.prototype, s.prototype = new l, s.prototype.constructor = s, s.prototype.instantiate = function() {};
    var j,
        k = !0;
    try {
    ...
    !function() {
      ...
      u("pushRegister_", function(e) {
        return function(n) {
          return e.call(this, n) ? !1 : (i ? this.reduceRegister_(i, n) : d ? this.reduceRegister_(t(), n) : l ? c.push(n) : this.reduceRegister_(null, n), !0);
        };
      }), u("fetch", function(t) {
        return function(i) {
          var u = this;
          return "json" != i.metadata.format && i.metadata.scriptLoad && (g || v) ? v ? n(u, i) : new Promise(function(t, n) {
            function f(e) {
              if (!h.readyState || "loaded" == h.readyState || "complete" == h.readyState) {
                if (l--, i.metadata.entry || c.length) {
                  if (!d) {
                    for (var r = 0; r < c.length; r++)
                      u.reduceRegister_(i, c[r]);
                    c = [];
                  }
                } else
                  u.reduceRegister_(i);
            ...
            h.async = !0, i.metadata.crossOrigin && (h.crossOrigin = i.metadata.crossOrigin), i.metadata.integrity && h.setAttribute("integrity", i.metadata.integrity), d ? (h.attachEvent("onreadystatechange", f), s.push({
              script: h,
              load: i
            })) : (h.addEventListener("load", f, !1), h.addEventListener("error", m, !1)), l++, a = e.System, h.src = i.address, r.appendChild(h);
          }) : t.call(this, i);
        };
      });
    }();
    ...
    !function() {
      function t(e, n, r) {
        if (r[e.groupIndex] = r[e.groupIndex] || [], -1 == w.call(r[e.groupIndex], e)) {
          ...
          for (var a = 0,
            ...
            var i = e.normalizedDeps[a],
                d = n.defined[i];
            if (d && !d.evaluated) {
              var s = e.groupIndex + (d.declarative != e.declarative);
              if (null === d.groupIndex || d.groupIndex < s) {
                if (null !== d.groupIndex && (r[d.groupIndex].splice(w.call(r[d.groupIndex], d), 1), 0 == r[d.groupIndex].length))
          ...
          var r = n._loader.moduleRecords,
              ...
              s = t.declare.call(e, function(e, t) {
                if (a.locked = !0, "object" == typeof e)
                  ...
                  d[e] = t;
                for (var r = 0,
                    o = a.importers.length; o > r; r++) {
                  var i = a.importers[r];
                  if (!i.locked) {
                    var s = w.call(i.dependencies, a);
                    i.setters[s](d);
                  }
                }
                return a.locked = !1, t;
              }, {id: t.name});
          if (a.setters = s.setters, a.execute = s.execute, !a.setters || !a.execute)
      ...
      function d(e, t) {
        var n,
            r = t.defined[e];
        if (r)
          r.declarative ? v(e, [], t) : r.evaluated || l(r, t), n = r.module.exports;
        else if (n = t.get(e), !n)
      ...
      function l(t, n) {
        if (!t.module) {
          ...
          if (!t.executingRequire)
            for (var i = 0,
                s = t.normalizedDeps.length; s > i; i++) {
              var u = t.normalizedDeps[i],
                  c = n.defined[u];
              c && l(c, n);
            }
          t.evaluated = !0;
          var f = t.execute.call(e, function(e) {
            ...
            if (-1 != w.call(t.normalizedDeps, o))
              return d(o, n);
      ...
      function v(t, n, r) {
        ...
        if (a && !a.evaluated && a.declarative) {
          n.push(t);
          for (var o = 0,
              i = a.normalizedDeps.length; i > o; o++) {
            var d = a.normalizedDeps[o];
            -1 == w.call(n, d) && (r.defined[d] ? v(d, n, r) : r.get(d));
          }
      ...
      s.prototype.register = function(e, t, n) {
        ...
        return function(t) {
          ...
          r || (r = h(), r.deps = t.metadata.deps, r.execute = function() {}), a.defined[t.name] = r;
          var o = f(r.deps);
          r.deps = o.names, r.originalIndices = o.indices, r.name = t.name, r.esmExports = t.metadata.esmExports !== !1;
          for (var i = [],
              d = 0,
              s = r.deps.length; s > d; d++)
            i.push(Promise.resolve(a.normalize(r.deps[d], t.name)));
          return Promise.all(i).then(function(e) {
            return r.normalizedDeps = e, {
              deps: r.deps,
              execute: function() {
                return n(t.name, a), v(t.name, [], a), a.defined[t.name] = void 0, a.newModule(r.declarative ? r.module.exports : r.esModule);
              }
            };
          });
        };
            ...
            for (var a in n.bundles) {
              for (var o = 0; o < n.bundles[a].length; o++) {
                ...
                if (-1 != i.indexOf("*")) {
                  ...
                  if (t.name.substring(0, d[0].length) == d[0] && t.name.substr(t.name.length - d[1].length, d[1].length) == d[1] && -1 == t.name.substr(d[0].length, t.name.length - d[1].length - d[0].length).indexOf("/")) {
                    r = !0;
                    break;
                  }
                }
    ...
    }), _ = new s, e.SystemJS = _, _.version = "0.19.24 Register Only", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, _ || (_ = new o, _.constructor = o), "object" == typeof exports && (module.exports = _), e.System = _;
