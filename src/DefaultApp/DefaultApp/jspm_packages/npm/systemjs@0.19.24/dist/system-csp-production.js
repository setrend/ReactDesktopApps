    ...
    function e() {
      !function(e) {
        ...
        function m(e) {
          ...
          if ("object" == typeof e || "function" == typeof e)
            if (H) {
              var n;
              for (var r in e)
                (n = Object.getOwnPropertyDescriptor(e, r)) && C(t, r, n);
            } else {
        ...
        function z(e, t, n) {
          return this["import"](e.module, t).then(function(t) {
            if (e.prop ? t = v(e.prop, t) : "object" == typeof t && t + "" == "Module" && (t = t["default"]), n && "boolean" != typeof t)
              throw new TypeError("Condition " + R(e) + " did not resolve to a boolean.");
            return e.negate ? !t : t;
          });
        }
        function M(e, t) {
        ...
        if ("undefined" != typeof document && document.getElementsByTagName) {
          ...
          U = "file://" + (D ? "/" : "") + process.cwd() + "/", D && (U = U.replace(/\\/g, "/"));
        else {
        ...
        C(r.prototype, "toString", {value: function() {
            return "Module";
          }}), function() {
          function o(e) {
            return {
          ...
          function v(e, t) {
            ...
            for (var a = 0,
              ...
              r = J.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
        ...
        var G = ["main", "format", "defaultExtension", "meta", "map", "basePath", "depCache"],
            V = /^[^\/]+:\/\//,
            Y = {},
            Z = new A(U);
        c(function(e) {
        ...
        l.prototype.config = function(e) {
          ...
          if (e.packageConfigPaths) {
            for (var d = [],
                c = 0; c < e.packageConfigPaths.length; c++) {
          ...
          if (e.packages)
            for (var r in e.packages) {
              ...
              for (var S in u)
                -1 == J.call(G, S) && g.call(n, '"' + S + '" is not a valid package configuration option in package ' + r);
              h(n.packages[s], u);
            }
          for (var E in e) {
            var o = e[E];
          ...
          function u(t, n) {
            if (!t.module) {
              ...
              if (!t.executingRequire)
                for (var i = 0,
                    l = t.normalizedDeps.length; l > i; i++) {
              ...
              var f = t.execute.call(e, function(e) {
                ...
                if (-1 != J.call(t.normalizedDeps, o))
                  return s(o, n);
